          ...
          <form onSubmit={onSubmit} className="mt-12 rounded-3xl bg-card hairline shadow-soft p-6 md:p-10 space-y-5">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pt-2">
              ...
              <button
                ...
                className="inline-flex items-center justify-center gap-2 rounded-full bg-accent text-accent-foreground px-6 py-3 text-sm font-medium shadow-glow hover:opacity-95 transition disabled:opacity-60"
              >
