  ...
  return (
    <section className="py-24 md:py-32">
      <div className="container-px mx-auto max-w-7xl">
        <Reveal>
          <div className="relative overflow-hidden rounded-3xl bg-card text-card-foreground p-10 md:p-16 shadow-card">
            ...
            <div className="relative grid lg:grid-cols-12 gap-10 items-center">
              <div className="lg:col-span-8">
                ...
                <p className="mt-5 text-muted-foreground max-w-xl leading-relaxed">{t.cta.desc}</p>
              </div>
              <div className="lg:col-span-4 lg:text-right">
                ...
                <div className="mt-4 text-xs text-muted-foreground">{t.cta.note}</div>
              </div>
            </div>
          </div>
        </Reveal>
